...
项目中已有 6 本教材共 1155 张 TikZ/circuitikz 高质量绘图，位于 `LaTeX_Project/附录_参考绘图/`。
索引文件：`Typst_Project/latex_resource_index.json`。
每本书目录下有 `index.tex` 可查看每张图的主题和来源行号。
...
| 章节 | tikz | Typst 位置 |
|------|------|----------|
| 磁场 | 22 | `figures/附录_物理第三册_电磁/磁场/` |
| 电磁感应 | 5 | `figures/附录_物理第三册_电磁/电磁感应/` |
| 交流电 | 20 | `figures/附录_物理第三册_电磁/交流电/` |
| 电磁振荡和电磁波 | 4 | `figures/附录_物理第三册_电磁/电磁振荡和电磁波/` |

#### 电路图 circuit（22 张 ✅ / 22 张跳过）

| 章节 | 完成 | 说明 |
|------|------|------|
| 电磁感应 | 10 | 电池+开关+电阻+灯泡+仪表+电感 |
| 交流电（简单） | 12 | AC源+R/L/C+滤波+功率+信号检波 |
| 交流电（复杂） | 跳过22张 | 变压器铁芯/三相线圈绘制质量不佳 |

正弦波工具函数：`figures/附录_物理第三册_电磁/交流电/_sine_utils.typ`
电路工具库：`figures/附录_物理第三册_电磁/_circuit_utils.typ`
聚合文件：`figures/附录_物理第三册_电磁/_appendix.typ`
