...
#cetz.canvas(length: 1cm, {
  ...
  let sq = 0.3
  let s = calc.sqrt(2)
  let u1 = (-1/s, -1/s)  // A→B 方向
  let u2 = ( 1/s, -1/s)  // A→C 方向
  let p1 = (2 + sq*u1.at(0), 2 + sq*u1.at(1))
  let p2 = (2 + sq*(u1.at(0)+u2.at(0)),
            2 + sq*(u1.at(1)+u2.at(1)))
  let p3 = (2 + sq*u2.at(0), 2 + sq*u2.at(1))
